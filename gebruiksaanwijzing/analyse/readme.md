...
Bij het bekijken van de 'position'-gegevens op de grafische weergave (Linefollower/gebruiksaanwijzing/analyse/Schermafbeelding%202025-11-29%20153837.png) ontstond aanvankelijk de gedachte dat een low-pass filter nodig was om de ruis van de sensoren te onderdrukken.
