...
Bij het bekijken van de 'position'-gegevens op de grafische weergave (Linefollower/gebruiksaanwijzing/analyse/Schermafbeelding 2025-11-29 15303.png) ontstond aanvankelijk de gedachte dat een low-pass filter nodig was om de ruis van de sensoren te onderdrukken.
